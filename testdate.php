    ...
    <h4 class="note">
      !ניתן לבצע בדיקות התאמה בכל ימי השבוע   </h4>
              ...
              <form action="inserttestdate.php" class="form-container" method="POST">
                  ...
                  <input type="text" placeholder="שם מלא" name="fname" required>

                  <label for="id"><b>ת"ז</b></label>
                  <input type="text" placeholder="ת''ז" name="id" required>
              
                  <label for="phone"><b>טלפון</b></label>
                  <input type="text" placeholder="טלפון" name="phone" required>
